...
{
    public partial class ShareScheme : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = ServiceDetailService.GetShareAccountLists();
            ...
            html.Append("Details For Share Accounts");
            html.Append("</h3>");
            html.Append("</tr>");
            ...
            SchemaSharePlaceHolder.Controls.Add(new Literal { Text = html.ToString() });
        }
    }
}