...
{
    public partial class HirePurchaseLoan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = ServiceDetailService.GetHirePurchaseLoanLists();
            ...
            html.Append("Interest Rate For Hire Purchase Loan Accounts");
            html.Append("</h3>");
            html.Append("</tr>");
