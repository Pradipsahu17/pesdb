<%@ Page Title="" Language="C#" MasterPageFile="~/ViewMaster.Master" AutoEventWireup="true" CodeBehind="AccountCommitte.aspx.cs" Inherits="BiduthKarmi.AccountCommitte" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentBody" runat="server">
    <div class="super-container" style="background-color: #4e73df">
        ...
        <div class="container" runat="server" id="EnglishDiv">
            <div class="row">
                <div class="span4   offset4">
                    <h2 style="text-align: right; color: white">ACCOUNT COMMITTE</h2>
                </div>
            </div>
            <div class="row">
                <div class="span5   offset5">
                    <div class="card1   border-left-dark border-right-dark   border-bottom-dark  border-top-dark " style="border-radius: 10px; background-color: #4e73df;">
                        ...
                        <img src="Img/BOD/IMG7.jpg" style="border-radius: 10px; height: 200px;" />
                        <div class="card1-header">
                            <h5 style="color: white; text-align: center">SHREE  BHAI SHRESTHA<br />
                                (Member)</h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="container" runat="server" id="NepaliDiv">
            <div class="row">
                <div class="span4   offset4">
                    <h2 style="text-align: center; color: white">&nbsp;&nbsp;&nbsp;&nbsp;लेखा समिति</h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="span5   offset5">
                    <div class="card1   border-left-dark border-right-dark   border-bottom-dark  border-top-dark " style="border-radius: 10px; background-color: #4e73df;">
                        ...
                        <img src="Img/BOD/IMG7.jpg" style="border-radius: 10px; height: 200px;" />
                        <div class="card1-header">
                            <h5 style="color: white; text-align: center">श्रीभाई श्रेष्ठ<br />
                                (सदस्य)</h5>
                        </div>
                    </div>
                </div>
