...
{
    public partial class loanscheme : System.Web.UI.Page
    {
        private int LID => Request.QueryString["id"].ToInt();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = ServiceDetailService.GetALLLoanLists();
            ...
            html.Append("Interest Rate For Loan Accounts");
            html.Append("</h3>");
            html.Append("</tr>");
