...
{
    public partial class ShareAgainstLoan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = ServiceDetailService.GetShareAgainstLoanLists();
            ...
            html.Append("Interest Rate For Share Against Loan Accounts");
            html.Append("</h3>");
            html.Append("</tr>");
